...
# Script parameters
numpics = 1000
# Camera distance from the central object
fixed_radius = 40  
# Used if variable_distance = True, meaning pictures are taken at varying distances
min_radius = 20
max_radius = 60
res_x = 1920
res_y = 1120
variable_distance = False  # Set this to True for variable distances
...
for i in range(0, numpics):
    ...
    distance = fixed_radius
    if variable_distance:
        distance = uniform(min_radius, max_radius)  # Random distance between min_radius & max_radius
